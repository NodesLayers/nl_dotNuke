...
def setWriteNode():
    ...
    if nuke.root().name() == "Root":
        ...
        print ("Script not saved correctly. Please save this script correctly before continuing!")
    elif nuke.root().name != "Root":

        ## Find sequence, shot, assetName & taskname from Nuke scriptName
        try:
            ...
            print ("Couldn't find Sequence or Shotcode in scriptname")
        ...
        ## PANEL
        p = nuke.Panel('Set Writenode '+myVersion)    
